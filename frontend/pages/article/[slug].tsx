...
const slug = ({ article, notFound = false }: IPropType) => {
        ...
        const notify = () => toast.success('🌟 Request Sended Successfully', {
            position: "top-right",
            autoClose: 2000,
    ...
    return (
        <>
            ...
            <div className="my-12 grid lg:grid-cols-3 gap-12 p-4 single-article">
                <div className="col-span-2">
                    <h1 className="text-3xl text-gray-200 font-bold py-2">
                    ...
                    <div className="text-lg text-gray-300 leading-8">
                        <img
                ...
                <div className="sticky top-0">
                    ...
                    <input
                        className="border w-full rounded-lg p-2 pl-3 my-6 outline-primary"
                        type="email"
                        placeholder="Your work email"
                    />
                    <button className="border-2 border-primary rounded py-1 px-6 text-primary font-bold hover:bg-green-500 hover:text-gray-200" onClick={notify}>
                        Subscribe
                    </button>
                    <ToastContainer
position="top-right"
...
/>
                    ...
                    <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
                        ...
                        {/* <a className="text-gray-500 hover:text-gray-300 cursor-pointer">
                            <svg
                                fill="currentColor"
                                strokeLinecap="round"
                        ...
                        <a className="ml-3 text-gray-500 hover:text-gray-300 cursor-pointer">
                            <svg
                                fill="currentColor"
                                strokeLinecap="round"
                                strokeLinejoin="round"
